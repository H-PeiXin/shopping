...
public class GridAdapter extends DelegateAdapter.Adapter {
    ...
    public GridAdapter(GridLayoutHelper gridLayoutHelper, ArrayList<HomeBean.DataDTO.BrandListDTO> brandlist) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        HomeBean.DataDTO.BrandListDTO brandListDTO = brandlist.get(position);
